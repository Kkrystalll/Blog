...
![看本機所有的 Images](/image/dockerDay7/7_1.webp)
...
![建立一個有新標籤的 Image](/image/dockerDay7/7_2.webp)
...
![repository 跟新標籤名稱可自訂](/image/dockerDay7/7_3.webp)
...
![使用簡寫建立新的 Repository](/image/dockerDay7/7_4.webp)
